...
exports.ReadPivotStateUseCase = void 0;
var tsyringe_1 = require("tsyringe");
var GetLastCycleUseCase_1 = require("../../Cycles/GetLastCycles/GetLastCycleUseCase");
var ReadPivotStateUseCase = /** @class */ (function () {
    function ReadPivotStateUseCase(pivotRepository, statesRepository) {
        this.pivotRepository = pivotRepository;
        this.statesRepository = statesRepository;
    }
    ReadPivotStateUseCase.prototype.execute = function (pivot_id) {
        return __awaiter(this, void 0, void 0, function () {
            var getLastCycleUseCase, pivot, state, variables, variableIsNotEmpty, stateAndVariable, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        pivot = _a.sent();
                        return [4 /*yield*/, this.statesRepository.findByPivotId(pivot_id)];
                    case 2:
                        state = _a.sent();
                    ...
                    case 3:
                        ...
                        stateAndVariable = state && variableIsNotEmpty;
                        result = {
                            pivot_id: pivot_id,
    ...
    ReadPivotStateUseCase = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)('PivotsRepository')),
        __param(1, (0, tsyringe_1.inject)('StatesRepository')),
        __metadata("design:paramtypes", [Object, Object])
    ], ReadPivotStateUseCase);
    return ReadPivotStateUseCase;
}());
exports.ReadPivotStateUseCase = ReadPivotStateUseCase;
