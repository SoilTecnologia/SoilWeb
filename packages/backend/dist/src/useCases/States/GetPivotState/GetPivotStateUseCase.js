...
exports.GetPivotStateUseCase = void 0;
var tsyringe_1 = require("tsyringe");
var GetLastCycleUseCase_1 = require("../../Cycles/GetLastCycles/GetLastCycleUseCase");
var GetPivotStateUseCase = /** @class */ (function () {
    function GetPivotStateUseCase(stateRepository, pivotRepository) {
        this.stateRepository = stateRepository;
        this.pivotRepository = pivotRepository;
    }
    GetPivotStateUseCase.prototype.execute = function (pivot_id) {
        return __awaiter(this, void 0, void 0, function () {
            var getLastCycleUseCase, pivot, state, variables, variableIsNotEmpty, stateAnVariabes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        pivot = _a.sent();
                        return [4 /*yield*/, this.stateRepository.findByPivotId(pivot_id)];
                    case 2:
                        state = _a.sent();
                        return [4 /*yield*/, getLastCycleUseCase.execute(pivot_id)];
                    case 3:
                        variables = _a.sent();
                        variableIsNotEmpty = variables && variables.length > 0;
                        stateAnVariabes = state && variableIsNotEmpty;
                        return [2 /*return*/, {
                                pivot_id: pivot_id,
    ...
    GetPivotStateUseCase = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)('StatesRepository')),
        __param(1, (0, tsyringe_1.inject)('PivotsRepository')),
        __metadata("design:paramtypes", [Object, Object])
    ], GetPivotStateUseCase);
    return GetPivotStateUseCase;
}());
exports.GetPivotStateUseCase = GetPivotStateUseCase;
