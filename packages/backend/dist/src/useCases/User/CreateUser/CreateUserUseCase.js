...
var User_1 = require("../../../database/model/User");
var CreateUserUseCase = /** @class */ (function () {
    function CreateUserUseCase(userRepository) {
        this.userRepository = userRepository;
    }
    CreateUserUseCase.prototype.createJwt = function (user) {
    ...
    CreateUserUseCase.prototype.execute = function (_a) {
        var login = _a.login, password = _a.password, user_type = _a.user_type;
        return __awaiter(this, void 0, void 0, function () {
            var encryptedPassword, userALreadyExists, userModel, newUser, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, bcrypt_1.default.hash(password, 10)];
                    case 1:
                        encryptedPassword = _b.sent();
                        return [4 /*yield*/, this.userRepository.findByLogin(login)];
                    case 2:
                        ...
                        return [4 /*yield*/, this.userRepository.create(userModel)];
                    case 3:
                        newUser = _b.sent();
                        user = newUser[0];
                        if (user) {
