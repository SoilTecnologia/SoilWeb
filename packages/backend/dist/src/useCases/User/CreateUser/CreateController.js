...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, login, password, user_type, createUserUseCase, result, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, login = _a.login, password = _a.password, user_type = _a.user_type;
