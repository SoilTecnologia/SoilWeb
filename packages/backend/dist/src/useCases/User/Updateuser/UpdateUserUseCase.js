...
var UpdateUserUseCase = /** @class */ (function () {
    ...
    UpdateUserUseCase.prototype.execute = function (_a) {
        var login = _a.login, password = _a.password, user_type = _a.user_type, user_id = _a.user_id;
        return __awaiter(this, void 0, void 0, function () {
            var userModel, selectUser, newUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userModel = new User_1.UserModel();
                        return [4 /*yield*/, this.userRepository.findById(user_id)];
                    case 1:
                        selectUser = _b.sent();
                        if (!selectUser) return [3 /*break*/, 3];
                        ...
                        return [4 /*yield*/, this.userRepository.putUser(userModel)];
                    case 2:
                        newUser = _b.sent();
