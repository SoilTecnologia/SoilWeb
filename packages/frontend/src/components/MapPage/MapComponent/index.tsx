...
const MapComponent = () => {
            ...
            if (pivotMapList.pivots) {
              pivotMapList.pivots.map((pivot) => {
                ...
                map.addLayer({
                  ...
                  layout: {
                    ...
                    "icon-size": [
                      ...
                      ["linear"],
                      ["zoom"],
                      11, ["/", ["/", pivot.pivot_radius, 35.914], 115],
                      12, ["/", ["/", pivot.pivot_radius, 17.957], 115],
                      13, ["/", ["/", pivot.pivot_radius, 8.978], 115],
                      14, ["/", ["/", pivot.pivot_radius, 4.489], 115],
                      15, ["/", ["/", pivot.pivot_radius, 2.245], 115],
                      16, ["/", ["/", pivot.pivot_radius, 1.122], 115],
                      17, ["/", ["/", pivot.pivot_radius, 0.561], 115],
                      18, ["/", ["/", pivot.pivot_radius, 0.28], 115],
                    ],
                ...
                map.on('mouseenter', `${pivot.pivot_id}`, (e) => {
                  ...
                  popup.setLngLat(e.lngLat).setHTML(`Pivô:${pivot.pivot_num}`).addTo(map);
                });
  ...
  return (
    ...
    <S.Container ref={el => (mapContainer.current = el)} />
